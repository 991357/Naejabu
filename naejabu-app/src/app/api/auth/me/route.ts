...
export async function GET(req: NextRequest) {
  try {
    ...
    const stmt = db.prepare('SELECT id, email, name, nickname, is_admin, role, english_name, hanja_name, birthdate, hobby, specialty, motto, is_temp_password, created_at, updated_at FROM users WHERE id = ?');
