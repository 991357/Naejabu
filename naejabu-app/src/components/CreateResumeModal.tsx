...
interface CreateResumeModalProps {
  onClose: () => void;
  onCreate: (data: any) => void; // Replace 'any' with a proper type later
}
  ...
  return (
    <div className="p-4 bg-gray-50 rounded-lg">
      <div className="flex justify-between items-center mb-8">
        <h2 className="text-4xl font-bold text-primary font-heading">새 자소서 만들기</h2>
      </div>
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div>
            ...
            {error && <p className="text-red-600 text-sm mb-4 bg-red-100 p-3 rounded-lg">{error}</p>}
